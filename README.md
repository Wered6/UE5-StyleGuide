...
- [2.1 General](#naming-general)
    ...
    - [2.1.3 Variables](#naming-general-vars)
        - [2.1.3.1 Nouns](#naming-general-vars-nouns)
        - [2.1.3.2 Booleans](#naming-general-vars-bools)
        - [2.1.3.3 Considered context](#naming-general-vars-context)
        - [2.1.3.4 Do *NOT* include atomic type names](#naming-general-vars-no-atomic)
        - [2.1.3.5 Arrays](#naming-general-vars-arrays)
    - [2.1.4 Functions](#naming-general-funcs)
        - [2.1.4.1 Verb Rule](#naming-general-funcs-verb-rule)
        - [2.1.4.2 Functions returning bool should ask questions](#naming-general-funcs-return-bool)
        - [2.1.4.3 RepNotify must be prefixed with `OnRep_`](#naming-general-funcs-repnotify)
        - [2.1.4.4 RPC must be prefixed with target](#naming-general-funcs-rpc-prefix)
- [2.2 Blueprints naming](#naming-bp)
    - [2.2.1 Base Asset Name - 'Prefix_BaseAssetName_Variant_Suffix'](#naming-bp-bas)
        - [2.2.1.1 Most common](#naming-bp-bas-common)
        - [2.2.1.2 Animations](#naming-bp-bas-animations)
        - [2.2.1.3 Artificial Intelligence](#naming-bp-bas-ai)
        - [2.2.1.4 Blueprints](#naming-bp-bas-bps)
        - [2.2.1.5 Materials](#naming-bp-bas-materials)
        - [2.2.1.6 Textures](#naming-bp-bas-textures)
            - [2.2.1.6.1 Texture packing](#naming-bp-bas-textures-packing)
        - [2.2.1.7 Miscellaneous](#naming-bp-bas-misc)
        - [2.2.1.8 Paper 2D](#naming-bp-bas-paper2d)
        - [2.2.1.9 Physics](#naming-bp-bas-physics)
...
- [4.2 Variables](#bp-vars)
    - [4.2.1 Editable variables](#bp-vars-editable)
        - [4.2.1.1 Descriptions](#bp-vars-editable-descriptions)
        - [4.2.1.2 Slider and value ranges](#bp-vars-editable-ranges)
    - [4.2.2 Categories](#bp-vars-categories)
    - [4.2.3 Variable access level](#bp-vars-access)
        - [4.2.3.1 Private variables](#bp-vars-access-private)
    - [4.2.4 Advanced Display](#bp-vars-advanced)
...
> |------------------|------------------------------------------------------------------------------------------|----------------------------------------------------|
> | ***PascalCase*** | Capitalize every word                                                                    | `DeserEagle`, `StyleGuide`, `ASeriesOfWords`       |
> | ***camelCase***  | The first letter is always lowercase, but every following wor starts with uppercase      | `desertEagle`, `styleGuide`, `aSeriesOfWords`      |
> | ***Snake_case*** | Words can arbitrarily start upper or lowercase, but words are separated by an underscore | `desert_Eagle`, `Style_Guide`, `a_Series_of_Words` |
...
## 3.3 Use `Developer` folder for local testing
...
### 4.2.1.2 Slider and value ranges
...
![Aligned By Wires](https://github.com/Wered6/UE5-StyleGuide/blob/main/images/bp-graph-align-wires-good.png?raw=true "Aligned By Wires")

**Bad Example:** The tops of the nodes are aligned, creating a wiggly white exec line.
![Bad](https://github.com/Wered6/UE5-StyleGuide/blob/main/images/bp-graph-align-wires-bad.png?raw=true "Wiggly")
...
![Acceptable](https://github.com/Wered6/UE5-StyleGuide/blob/main/images/bp-graph-align-wires-acceptable.png?raw=true "Acceptable")
...
![Good](https://github.com/Wered6/UE5-StyleGuide/blob/main/images/bp-graph-getters-invoking-good.png?raw=true "Good")

**Bad example:** Wires are connected to one getter, it might be less readable in longer connections.
![Bad](https://github.com/Wered6/UE5-StyleGuide/blob/main/images/bp-graph-getters-invoking-bad.png?raw=true "Bad")
