...
- [2.1 General](#naming-general)
    ...
    - [2.1.5 Functions](#naming-general-funcs)
        - [2.1.5.1 Verb Rule](#naming-general-funcs-verb-rule)
        - [2.1.5.2 Functions returning bool should ask questions](#naming-general-funcs-return-bool)
        - [2.1.5.3 RepNotify must be prefixed with `OnRep_`](#naming-general-funcs-repnotify)
        - [2.1.5.4 RPC must be prefixed with target](#naming-general-funcs-rpc-prefix)
